        ...
        justify-center items-center xl:items-start xl:pl-8'>
          ...
          xl:border-black/10">
            <div className="flex flex-col justify-center">
              ...
              xl:ml-6 xl:text-left">{location}</div>
            </div>
          </div>
        ...
        text-center xl:text-left w-full bg-white max-w-[332px] py-6 rounded-[10px]'>
          {locations.map((location,index)=>{
            return(
              ...
              //will replace
              <div key={index} onClick={()=>setLocation(location)} className="
              cursor-pointer py-4 xl:pl-10 hover:bg-gray-50 text-[13px] uppercase">
                {location}
              </div>
            )
          })}
